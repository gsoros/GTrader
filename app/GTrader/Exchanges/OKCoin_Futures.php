...
class OKCoin_Futures extends Exchange
{
                                ...
                                int $bot_id = null)
    {
        ...
        else throw new \Exception('unknown signal');
    ...
    private function trade( string $action,
                            float $price,
                            int $num_contracts,
                            string $symbol,
                            int $leverage,
    ...
    private function getOrderHistory(string $symbol,
                                    string $status,
                                    int $current_page = 1,
                                    int $page_length = 200)
    {
