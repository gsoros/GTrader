...
return [
    'name'              => 'OKEX_BTC_Futures',  // class name, also used in the local database
    'long_name'         => 'OKEX BTC Futures',  // human-readable name
    ...
    'symbols' => [
        'btc_usd_3m' => [                           // used in the local database, same as symbolname.name
            'name'              => 'btc_usd_3m',    // used in the local database, same as the key
            'long_name'         => 'Quarterly',     // human-readable name
