...
<div class="row bdr-rad">
    ...
    <div class="form-group editable">
        <label class="col-sm-3 control-label" for="sample_size">Sample size</label>
        <div class="col-sm-9">
    ...
    <div class="form-group editable">
        <label class="col-sm-3 control-label" for="hidden_array">Hidden layers</label>
        <div class="col-sm-9">
            <input class="btn-primary form-control form-control-sm"
                type="text"
                id="hidden_array"
    ...
    <div class="form-group editable">
        <label class="col-sm-3 control-label" for="target_distance">Prediction distance</label>
        <div class="col-sm-9">
            <input class="btn-primary form-control form-control-sm"
                type="number"
                id="target_distance"
